...
@font-face{{font-family:P;font-weight:400;src:url({fonts}/pixelify-sans-latin-400-normal.woff2)}}
@font-face{{font-family:P;font-weight:700;src:url({fonts}/pixelify-sans-latin-700-normal.woff2)}}
